...
import styles from '../styles/mobileEditor.module.css';
//icons
...
import { faSun, faAdjust, faCropSimple, faDownload, faImage, faCircle, faPalette, faDroplet } from '@fortawesome/free-solid-svg-icons';
            ...
            <div className={`container w-75 mt-3 p-3 mb-5 bg-body-tertiary rounded`}>
                ...
                <main className={styles.editor}>
                    {image && <div className={styles.save_button}>
                        <button className={`btn btn-outline-secondary ${styles.change_image} m-1 text-dark`} onClick={imageHandle}><FontAwesomeIcon icon={faImage} /></button>
                        <button className={`btn btn-success ${styles.download}`} onClick={saveImage}><FontAwesomeIcon icon={faDownload} /></button>
                        {crop &&

<button className={`${styles["option-button"]} text-capitalize float-end`} onClick={imageCrop}><FontAwesomeIcon icon={faCropSimple} /></button>
}
                    </div>}
                    ...
                    <div className={styles.image}>
                        ...
                        {image && <div className={`d-flex gap-3 ${styles.range}`}>
                            Amount
                            ...
                            <p className='px-3'>{options[selectedOptionIndex].value} {options[selectedOptionIndex].unit}</p>
                        ...
                        >
                            ...
                            <pre>{options[selectedOptionIndex].name}</pre>
                            <ul>

                                {
                                    defaultFilters.map((v, i) => (

                                        <li key={i}>
                                            <button className={`${styles['option-button']} text-capitalize mx-1 ${i === selectedOptionIndex ? styles.active : ''}`} onClick={() => setSelectedOptionIndex(i)}>{v.icon}</button>
                                        </li>
